...
public class DuelsUserConfiguration extends DuelsConfiguration {
    private String username;
    private final UUID uuid;

    public DuelsUserConfiguration(final String username, final UUID uuid, final File configFile) {
        super(configFile);
    ...
    public void convertLegacyFile() {
        ...
        try {
            ...
            Duels.getWrappedLogger().log(Level.WARNING, "Failed to migrate user: " + username, ex);
        }
