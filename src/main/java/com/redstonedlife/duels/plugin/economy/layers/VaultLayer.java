package com.redstonedlife.duels.plugin.economy.layers;

import com.redstonedlife.duels.plugin.economy.EconomyLayer;
...
public class VaultLayer implements EconomyLayer {
    ...
    public boolean onServerLoad() {
        ...
        return adapter != null && !adapter.getName().equals("Essentials Economy") && !adapter.getName().equals("Duels Economy");
    }
