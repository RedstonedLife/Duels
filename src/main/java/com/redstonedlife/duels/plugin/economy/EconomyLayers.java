package com.redstonedlife.duels.plugin.economy;

import com.redstonedlife.duels.plugin.Duels;
import com.redstonedlife.duels.plugin.economy.layers.VaultLayer;
...
public final class EconomyLayers {
    ...
    public static void onEnable(final Duels duels) {
        duels.scheduleSyncDelayedTask(() -> {
            serverStarted = true;
            for (final Plugin plugin : Bukkit.getPluginManager().getPlugins()) {
                ...
                if (layer != null) {
                    duels.getLogger().log(Level.INFO, "Essentials found a compatible payment resolution method: " + layer.getName() + " (v" + layer.getPluginVersion() + ")!");
                }
            }
